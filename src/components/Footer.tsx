...
export function Footer() {
  return (
    <footer className="relative mt-32 border-t border-border/60">
      <div className="mx-auto max-w-6xl px-4 py-12 grid gap-10 sm:grid-cols-2 md:grid-cols-3">
        <div>
          <Link to="/" className="font-display text-xl font-semibold">
            {profile.firstName}
            <span className="gradient-text">.dev</span>
          </Link>
          <p className="mt-3 text-sm text-muted-foreground max-w-xs">{profile.tagline}</p>
        </div>
        <div>
